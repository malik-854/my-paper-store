...
window.placeOrder = async function () {
    ...
    try {
        ...
        if (phone) {
            const msg = `✅ *Kiosk Order Received*\n-------------------------\nCustomer: ${name}\nOrder Link: ${invoiceLink}\n\nOrder Id: ${orderId}\n💰 *Please show this message at the counter to proceed.*\n\nشکریہ! اگلی بار گھر بیٹھے آرڈر اور تازہ ترین ریٹس کے لیے ہماری ویب سائٹ:\n🌐 www.hayyatstore.com وزٹ کریں۔\n\n📲 باخبر رہنے کے لیے ہمارا واٹس ایپ چینل فالو کریں:\nhttps://whatsapp.com/channel/0029Vb7Zi9ZGE56cYQFOPf0O`;
